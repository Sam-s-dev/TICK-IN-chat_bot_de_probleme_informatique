...
import {
  ...
  Wrench, Check, CheckCheck, AlertCircle, Info, Calendar, Star
...
const notifIcon = (type) => ({ status_change: Info, assignment: AlertCircle, reminder: AlertCircle, new_ticket: Bell, new_message: Bell, evaluation: Star }[type] || Bell)
const notifColor = (type) => ({ status_change: 'text-blue-600 bg-blue-50', assignment: 'text-purple-600 bg-purple-50', reminder: 'text-orange-600 bg-orange-50', new_ticket: 'text-primary bg-primary/10', new_message: 'text-primary bg-primary/10', evaluation: 'text-yellow-600 bg-yellow-50' }[type] || '')
